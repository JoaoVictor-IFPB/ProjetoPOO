...
public class ItemManager {
    ...
    public ItemManager(GerenciadorCardapio gerenciadorCardapio, TelaInicialController telaInicialController) { this.gerenciadorCardapio = gerenciadorCardapio;
    ...
    public void removerPizza(String nome, Label label) {
        ItemCardapio item = gerenciadorCardapio.getItens().stream()
                .filter(i -> i.getNome().equals(nome))
                .findFirst()
                .orElse(null);
